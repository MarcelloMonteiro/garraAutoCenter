...
<h2 class="h-two"> Ao Sistema de Controle de Ordens de Serviço</h2>
    <img src="<?php echo base_url() ?>assets/img/dashboard-animate.svg" class="left-login-image" alt="Garra Auto Center - Versão: <?= $this->config->item('app_version'); ?>">
</div>
<div id="loginbox">
        ...
        <div class="container">
          <div class="card">
            <div class="content">
              ...
              <div class="links-uteis"><a href="https://github.com/RamonSilva20/mapos"><p><?= date('Y'); ?> &copy; LM Soluções Tecnologicas</p></a>
              </div>
              <a href="#notification" id="call-modal" role="button" class="btn" data-toggle="modal" style="display: none ">notification</a>
              <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-header">
                  <h4 id="myModalLabel">Garra Auto Center</h4>
                </div>
